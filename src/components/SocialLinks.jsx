...
const socialLinks = [
  {
    ...
    subText: "on LinkedIn",
    icon: Linkedin,
    url: "https://www.linkedin.com/in/shahil-mansuri-001766365/",
    color: "#0A66C2",
  ...
  },
  {
    ...
    subText: "@shahilonly____",
    icon: Instagram,
    url: "https://www.instagram.com/shahilonly____?igsh=M3E0NDQzamgwd29x&utm_source=qr",
    color: "#E4405F",
  ...
  },
  {
    ...
    subText: "@Shahil522",
    icon: Github,
    url: "https://github.com/Shahil522",
    color: "#ffffff",
